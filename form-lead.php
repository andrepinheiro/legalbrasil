	...
	<div class="col-xs-12">
		<ul class="nav nav-pills nav-justified thumbnail setup-panel">
			<li class="active"><a href="#step-1">
				<h4 class="list-group-item-heading">1. Detalhes de sua solicitação</h4>
			</a></li>
	...
	<div class="row setup-content" id="step-1">
		<div class="form-group col-sm-6">
			...
			<select class="form-control">
				...
				<option value="direito-civil">Área civil</option>
				<option value="societario">Direito societário e comercial</option>
		...
		<div class="form-group col-md-3">
			...
			<select class="form-control">
				...
				<option value="filtro">Sao Paulo</option>
				<option value="filtro">Rio de Janeiro</option>
				<option value="filtro">Manaus</option>
				<option value="filtro">Etc.</option>
			</select>
		</div>
		<div class="form-group col-md-6">
		...
		<div class="form-group col-xs-12 col-md-12">
			<textarea class="form-control" placeholder="Conte-nos brevemente sobre seu caso e do que necessita" rows="4"></textarea>
		</div>
		<div class="col-md-12">
